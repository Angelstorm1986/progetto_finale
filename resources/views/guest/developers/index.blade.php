...
<div class="jumbotron">
    <div class="cover">
        <div class="positioner">
            <h1 class="display-1 d-sm-none d-xs-block d-md-block">[BD]</h1>
            <h1 class="d-none d-sm-block">Il portale che ti permette di cercare collaboratori in tutto il mondo.</h1>
            <p class="lead">
            Cerca tra migliaia di sviluppatori e scopri quale di queste possa fare per te. <br>
            Semplice e sicuro.
            </p>
        </div>
        <p class="d-none d-sm-block lead register"><a href="{{ route('register') }}">Sei uno sviluppatore? Unisciti a noi!</a></p>
    </div>
...
<div class="container">
    ...
    <form action="" method="post">
        <div class="form-group flex-column flex-xl-row">
            <div>
                <label for="language" class="form-label">Filtra gli sviluppatori secondo linguaggio:</label>
                <select @change="filtra" name="language_id" id="language" class="form-control" v-model="selectedLanguage">
                    <option value="nulla">Seleziona linguaggio</option>
    ...
    <div class="row" v-if="developers.length > 0">
        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3" v-for="(developer, index) in developers">
            ...
            <div class="card-container m-3">
                <div class="img-container d-flex justify-content-center">
                    <a class="text-decoration-none text-reset" :href="'http://127.0.0.1:8000/guest/developers/' + developer.id">
